...
class DropdownView: UIView {
    ...
    override func layoutSubviews() {
        ...
        case .leftDown:
            self.topAnchor.constraint(equalTo: button.topAnchor, constant: 0).isActive = true
            self.rightAnchor.constraint(equalTo: button.rightAnchor, constant: 0).isActive = true
